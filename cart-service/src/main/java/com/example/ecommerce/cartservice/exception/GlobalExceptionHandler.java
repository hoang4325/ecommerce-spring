...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiErrorResponse> handleNotFoundException(RuntimeException ex, HttpServletRequest request) {
    ...
    ResponseEntity<ApiErrorResponse> handleProductCatalogUnavailableException(
    ...
    ResponseEntity<ApiErrorResponse> handleInvalidCartOperationException(
    ...
    ResponseEntity<ApiErrorResponse> handleMissingUserIdentityException(
        MissingUserIdentityException ex,
        HttpServletRequest request
    ) {
