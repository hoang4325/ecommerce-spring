...
@SpringBootTest(classes = ProductServiceApplication.class, properties = {
    ...
    "spring.datasource.url=jdbc:h2:mem:product_service_openapi;MODE=PostgreSQL;DB_CLOSE_DELAY=-1",
...
class OpenApiEndpointTests {
    ...
    @Test
    void apiDocsEndpointReturnsProductServiceOpenApiMetadata() throws Exception {
